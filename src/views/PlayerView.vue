<template>
	...
	<div class="containerArt">
		...
		<div
			class="MatchsStats"
			v-for="matchesInfo in matchesInfos"
			:key="matchesInfo.metadata.matchId"
		>
			<div class="nameStats">
			...
			<div
				v-for="participant in matchesInfo.info.participants"
				:key="participant.puuid"
			>
				<div
					class="test"
					v-if="participant.teamId == 100"
				>
					<div class="namePlayers">
						<div
							class="winTeam"
							v-if="participant.win === true && participant.teamId == 100"
						>
							Win
						</div>
			...
			>
				<div
					class="test"
					v-if="participant.teamId == 200"
				>
					<div class="namePlayers">
						<div
							class="winTeam"
							v-if="participant.win === true && participant.teamId == 200"
						>
							Win
						</div>
						<img
